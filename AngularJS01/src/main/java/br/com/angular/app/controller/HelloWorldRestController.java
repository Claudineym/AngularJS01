 ...
 * 
 */
package br.com.angular.app.controller;
...
import br.com.angular.app.service.UserService;
  ...
  //-------------------Create a User--------------------------------------------------------
    ...
    public ResponseEntity<String> createUser(@RequestBody User user,    UriComponentsBuilder ucBuilder) {
        ...
        if (userService.isUserExist(user)) {
            ...
            return new ResponseEntity<String>("message:" + user.getUserName(), HttpStatus.CONFLICT);
        }
