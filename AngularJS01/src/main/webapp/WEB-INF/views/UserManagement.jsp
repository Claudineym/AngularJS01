...
<body ng-app="myApp" class="ng-cloak">
      <div class="generic-container" ng-controller="UserController as ctrl">
				    ...
				    <alert ng-repeat="alert in alerts" type="{{alert.type}}" close="closeAlert($index)">{{alert.msg}}</alert>
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.user.city" id="address" class="form-control input-sm" placeholder="Enter your Address. [This field is validation free]"/>
                              </div>
                          </div>
                      </div>
          ...
          <div class="panel panel-default">
              ...
              <div class="tablecontainer">
                  <table class="table table-hover" ng-change="refreshGrid()">
                      <thead>
                          <tr>
                              <th>ID.</th>
                              <th>Name</th>
      ...
      <script src="./static/js/controller/bootstrap.min.js"></script>
      <script src="./static/js/app.js"></script>
      <script src="./static/js/service/alertService.js"></script>
